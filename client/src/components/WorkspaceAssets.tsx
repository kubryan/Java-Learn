...
import { Archive, Braces, Check, Download, FileCode2, FileJson, FileText, FileType, Image, Link2, Loader2, Paperclip, Plus, Search, Trash2, X } from "lucide-react";
